...
/* songjinguo@wind-mobi.com 2011.12.02 start */
...
/* songjinguo@wind-mobi.com 2011.12.02 end */
//  Module declarations.
//
...
UInt32 GetVoiceChannelId(AudioMode_t mode)
{
	...
	switch(mode)
	{
		...
		case AUDIO_MODE_TTY_HCO:
		case AUDIO_MODE_TTY_HCO_WB:
			voice_chnl = 6;
			break;
		case AUDIO_MODE_TTY_VCO:
		case AUDIO_MODE_TTY_VCO_WB:
			voice_chnl = 7;
			break;
		default:
             ...
             unsigned int cmd, UInt32 arg)
{
    ...
    case PCG_IOCTL_SETMODE:
    {
		...
		else if (cur_channel == 6) // HCO mode
			AUDCTRL_DisableTelephony(AUDIO_HW_VOICE_IN,AUDIO_HW_VOICE_OUT,AUDCTRL_MIC_AUX,AUDCTRL_SPK_HANDSET);
		else if (cur_channel == 7) // VCO mode	
			AUDCTRL_DisableTelephony(AUDIO_HW_VOICE_IN,AUDIO_HW_VOICE_OUT,AUDCTRL_MIC_MAIN,AUDCTRL_SPK_HEADSET);
		...
		else if (voice_chnl == 6) // HCO mode
			AUDCTRL_EnableTelephony(AUDIO_HW_VOICE_IN,AUDIO_HW_VOICE_OUT,AUDCTRL_MIC_AUX,AUDCTRL_SPK_HANDSET);
		else if (voice_chnl == 7) // VCO mode
			AUDCTRL_EnableTelephony(AUDIO_HW_VOICE_IN,AUDIO_HW_VOICE_OUT,AUDCTRL_MIC_MAIN,AUDCTRL_SPK_HEADSET);
...
//songjinguo@wind-mobi.com 20120712 begin
//fix bug 12891;
					//if (voip.val3 == AUDIO_MODE_HEADSET)
					//	AUDCTRL_ECreset_NLPoff(TRUE);
//songjinguo@wind-mobi.com 20120712 end
