...
// -------Turn everything OFF   
  ...
  //xiongbiao@wind-mobi.com 20120307 start
  //add xia lang camera on L400_xal 
  #ifdef CONFIG_BCM_CAM_S5K5CA_XIA_LANG	 
    {GPIO_CNTRL, HAL_CAM_PWDN,       GPIO_SetLow},
  #else
    {GPIO_CNTRL, HAL_CAM_PWDN,       GPIO_SetHigh},
  #endif
   //xiongbiao@wind-mobi.com 20120307 end
    {PAUSE, 1, Nop_Cmd},
    //{PAUSE,      50,               Nop_Cmd},
// -------Disable Reset 
...
static HAL_CAM_Result_en_t Init_Mt9t111(CamSensorSelect_t sensor)
{
	   ...
	   // added for debug only, modify by zhaoqiang for remove straight line on preview mode or take picture
		mt9t111_write(0x0028 , 0xD000); 
...
/*
		...
		*/
		...
		mt9t111_write(0x0F12 , 0x020D);   //0163   //TVAR_wbt_pBaseCcmS[36] //
		mt9t111_write(0x0F12 , 0xFFA9);   //FF77   //TVAR_wbt_pBaseCcmS[37] //
		mt9t111_write(0x0F12 , 0xFFE2);   //FFBF   //TVAR_wbt_pBaseCcmS[38] //
		mt9t111_write(0x0F12 , 0xFE9E);   //FEC0   //TVAR_wbt_pBaseCcmS[39] //
		mt9t111_write(0x0F12 , 0x0133);   //0111   //TVAR_wbt_pBaseCcmS[40] //
		mt9t111_write(0x0F12 , 0xFED5);   //FEAB   //TVAR_wbt_pBaseCcmS[41] //
		mt9t111_write(0x0F12 , 0xFFC1);   //FFA2   //TVAR_wbt_pBaseCcmS[42] //
		mt9t111_write(0x0F12 , 0x0003);   //FFB9   //TVAR_wbt_pBaseCcmS[43] //
		mt9t111_write(0x0F12 , 0x01C7);   //023A   //TVAR_wbt_pBaseCcmS[44] //
		mt9t111_write(0x0F12 , 0x010F);   //014F   //TVAR_wbt_pBaseCcmS[45] //
		mt9t111_write(0x0F12 , 0x00A5);   //0096   //TVAR_wbt_pBaseCcmS[46] //
		mt9t111_write(0x0F12 , 0xFEC9);   //FF06   //TVAR_wbt_pBaseCcmS[47] //
		mt9t111_write(0x0F12 , 0x0220);   //01CF   //TVAR_wbt_pBaseCcmS[48] //
		mt9t111_write(0x0F12 , 0xFF6B);   //FF54   //TVAR_wbt_pBaseCcmS[49] //
		mt9t111_write(0x0F12 , 0x01B6);   //01CD   //TVAR_wbt_pBaseCcmS[50] //
		mt9t111_write(0x0F12 , 0xFEFE);   //FEE7   //TVAR_wbt_pBaseCcmS[51] //
		mt9t111_write(0x0F12 , 0x0140);   //0106   //TVAR_wbt_pBaseCcmS[52] //
		mt9t111_write(0x0F12 , 0x00F5);   //00F3   //TVAR_wbt_pBaseCcmS[53] //
		
		mt9t111_write(0x0F12 , 0x020D);   //01E7  //01FA   //TVAR_wbt_pBaseCcmS[54] //
		mt9t111_write(0x0F12 , 0xFFA9);   //FFAE  //FF9B   //TVAR_wbt_pBaseCcmS[55] //
		mt9t111_write(0x0F12 , 0xFFE2);   //0001  //FFFF   //TVAR_wbt_pBaseCcmS[56] //
		mt9t111_write(0x0F12 , 0xFE9E);   //FECD  //FE9F   //TVAR_wbt_pBaseCcmS[57] //
		mt9t111_write(0x0F12 , 0x0133);   //00E6  //010F   //TVAR_wbt_pBaseCcmS[58] //
		mt9t111_write(0x0F12 , 0xFED5);   //FEEF  //FEF5   //TVAR_wbt_pBaseCcmS[59] //
		mt9t111_write(0x0F12 , 0xFFC1);   //FFA6  //FFD2   //TVAR_wbt_pBaseCcmS[60] //
		mt9t111_write(0x0F12 , 0x0003);   //FFF9  //0015   //TVAR_wbt_pBaseCcmS[61] //
		mt9t111_write(0x0F12 , 0x01C7);   //01E9  //01A1   //TVAR_wbt_pBaseCcmS[62] //
		mt9t111_write(0x0F12 , 0x010F);   //0104  //0111   //TVAR_wbt_pBaseCcmS[63] //
		mt9t111_write(0x0F12 , 0x00A5);   //00A6  //009D   //TVAR_wbt_pBaseCcmS[64] //
		mt9t111_write(0x0F12 , 0xFEC9);   //FECF  //FECB   //TVAR_wbt_pBaseCcmS[65] //
		mt9t111_write(0x0F12 , 0x0220);   //01E1  //01FC   //TVAR_wbt_pBaseCcmS[66] //
		mt9t111_write(0x0F12 , 0xFF6B);   //FF96  //FF99   //TVAR_wbt_pBaseCcmS[67] //
		mt9t111_write(0x0F12 , 0x01B6);   //01C7  //01A9   //TVAR_wbt_pBaseCcmS[68] //
		mt9t111_write(0x0F12 , 0xFEFE);   //FF2B  //FF26   //TVAR_wbt_pBaseCcmS[69] //
		mt9t111_write(0x0F12 , 0x0140);   //0140  //012B   //TVAR_wbt_pBaseCcmS[70] //
		mt9t111_write(0x0F12 , 0x00F5);   //00C5  //00DF   //TVAR_wbt_pBaseCcmS[71] //
		
		mt9t111_write(0x0F12 , 0x01ED);   //01C6  //01E2   //TVAR_wbt_pBaseCcmS[72] //
		mt9t111_write(0x0F12 , 0xFF95);   //FFA5  //FF9A   //TVAR_wbt_pBaseCcmS[73] //
		mt9t111_write(0x0F12 , 0x000A);   //FFF7  //FFE7   //TVAR_wbt_pBaseCcmS[74] //
		mt9t111_write(0x0F12 , 0xFEB0);   //FF23  //FE9F   //TVAR_wbt_pBaseCcmS[75] //
		mt9t111_write(0x0F12 , 0x00EE);   //0198  //010F   //TVAR_wbt_pBaseCcmS[76] //
		mt9t111_write(0x0F12 , 0xFF08);   //FF33  //FEF5   //TVAR_wbt_pBaseCcmS[77] //
		mt9t111_write(0x0F12 , 0xFFF2);   //FFA8  //FFD2   //TVAR_wbt_pBaseCcmS[78] //
		mt9t111_write(0x0F12 , 0xFFC9);   //FFDF  //FFFE   //TVAR_wbt_pBaseCcmS[79] //
		mt9t111_write(0x0F12 , 0x01D3);   //01FF  //01B7   //TVAR_wbt_pBaseCcmS[80] //
		mt9t111_write(0x0F12 , 0x00C7);   //00D7  //00E8   //TVAR_wbt_pBaseCcmS[81] //
		mt9t111_write(0x0F12 , 0x00CA);   //00D4  //0095   //TVAR_wbt_pBaseCcmS[82] //
		mt9t111_write(0x0F12 , 0xFEEE);   //FF37  //FF0D   //TVAR_wbt_pBaseCcmS[83] //
		mt9t111_write(0x0F12 , 0x0226);   //0158  //0182   //TVAR_wbt_pBaseCcmS[84] //
		mt9t111_write(0x0F12 , 0xFF16);   //FF1F  //FF29   //TVAR_wbt_pBaseCcmS[85] //
		mt9t111_write(0x0F12 , 0x01B5);   //017A  //0146   //TVAR_wbt_pBaseCcmS[86] //
		mt9t111_write(0x0F12 , 0xFE89);   //FF3A  //FF26   //TVAR_wbt_pBaseCcmS[87] //
		mt9t111_write(0x0F12 , 0x01BC);   //0163  //012B   //TVAR_wbt_pBaseCcmS[88] //
		mt9t111_write(0x0F12 , 0x00F0);   //0093  //00DF   //TVAR_wbt_pBaseCcmS[89] //
		
		mt9t111_write(0x0F12 , 0x01ED);   //01C6  //01E2   //TVAR_wbt_pBaseCcmS[90] //
		mt9t111_write(0x0F12 , 0xFF95);   //FFA5  //FF9A   //TVAR_wbt_pBaseCcmS[91] //
		mt9t111_write(0x0F12 , 0x000A);   //FFF7  //FFE7   //TVAR_wbt_pBaseCcmS[92] //
		mt9t111_write(0x0F12 , 0xFEB0);   //FF23  //FE9F   //TVAR_wbt_pBaseCcmS[93] //
		mt9t111_write(0x0F12 , 0x00EE);   //0198  //010F   //TVAR_wbt_pBaseCcmS[94] //
		mt9t111_write(0x0F12 , 0xFF08);   //FF33  //FEF5   //TVAR_wbt_pBaseCcmS[95] //
		mt9t111_write(0x0F12 , 0xFFF2);   //FFA8  //FFD2   //TVAR_wbt_pBaseCcmS[96] //
		mt9t111_write(0x0F12 , 0xFFC9);   //FFDF  //FFFE   //TVAR_wbt_pBaseCcmS[97] //
		mt9t111_write(0x0F12 , 0x01D3);   //01FF  //01B7   //TVAR_wbt_pBaseCcmS[98] //
		mt9t111_write(0x0F12 , 0x00C7);   //00D7  //00E8   //TVAR_wbt_pBaseCcmS[99] //
		mt9t111_write(0x0F12 , 0x00CA);   //00D4  //0095   //TVAR_wbt_pBaseCcmS[100] //
		mt9t111_write(0x0F12 , 0xFEEE);   //FF37  //FF0D   //TVAR_wbt_pBaseCcmS[101] //
		mt9t111_write(0x0F12 , 0x0226);   //0158  //0182   //TVAR_wbt_pBaseCcmS[102] //
		mt9t111_write(0x0F12 , 0xFF16);   //FF1F  //FF29   //TVAR_wbt_pBaseCcmS[103] //
		mt9t111_write(0x0F12 , 0x01B5);   //017A  //0146   //TVAR_wbt_pBaseCcmS[104] //
		mt9t111_write(0x0F12 , 0xFE89);   //FF3A  //FF26   //TVAR_wbt_pBaseCcmS[105] //
		mt9t111_write(0x0F12 , 0x01BC);   //0163  //012B   //TVAR_wbt_pBaseCcmS[106] //
		mt9t111_write(0x0F12 , 0x00F0);   //0093  //00DF   //TVAR_wbt_pBaseCcmS[107] //
		...
		mt9t111_write(0x002A , 0x0212); 
		mt9t111_write(0x0F12 , 0x0005);// fxp@wind_reduce sharpness
		mt9t111_write(0x002A , 0x0210); 
		mt9t111_write(0x0F12 , 0x0010); //fxp@wind_improve contrast
		...
		// modify by zhaoqiang for remove straight line on preview mode or take picture
		mt9t111_write(0x0F12 , 0x2EE0); 	//REG_TC_IPRM_InClockLSBs//input clock=24MHz->12Mhz5DC0
		...
		// modify by zhaoqiang for remove straight line on preview mode or take picture
		mt9t111_write(0x0F12 , 0x0042);//0040 old: 0x0050 	 //REG_0TC_PCFG_PVIMask 2 92->96->52->5A->5C						2	7000027A	//92  (1) PCLK inversion  (4)1b_C first (5) UV First
		...
		mt9t111_write(0x0F12 , 0x07D0);    //REG_0TC_PCFG_usMaxFrTimeMsecMult10 		2	70000288	//0x0535
		...
		#ifdef CONFIG_BCM_CAM_S5K5CA_XIA_LANG    //hanwei 2012.03.19 add for fix bug#9294 xialang preview and capture mirror
		mt9t111_write(0x0F12 , 0x0000);    //REG_0TC_PCFG_uPrevMirror	old:	0x0002			2	70000296	//
		mt9t111_write(0x0F12 , 0x0000);    //REG_0TC_PCFG_uCaptureMirror old:0x0002				2	70000298	//
		#else
		mt9t111_write(0x0F12 , 0x0003);    //REG_0TC_PCFG_uPrevMirror					2	70000296	//
		mt9t111_write(0x0F12 , 0x0003);    //REG_0TC_PCFG_uCaptureMirror	hanwei			2	70000298	//
		#endif
		...
		//modify by zhaoqiang for remove straight line on preview mode or take picture
		mt9t111_write(0x0F12 , 0x0042); //0040 //0092	 //REG_0TC_CCFG_PVIMask 						2	7000036C		  //
