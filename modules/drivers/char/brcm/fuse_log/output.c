...
{
//yangjingwei@wind-mobi.com 2012.4.24 begin
//#9365
//start catch log in sd card, stop, plug in usb cable, cant switch to usb share mode
#if 1 //dont check size, vfs_statfs will cause trouble. yjw

	return MTT_SD_RESERVED*2;
#else
//yangjingwei@wind-mobi.com 2012.4.24 end
...
int BCMLOG_OutputInit( void )
{
	...
	g_devWrParms.wq = create_freezeable_workqueue("fuse_log_work");
	if (!g_devWrParms.wq) {
