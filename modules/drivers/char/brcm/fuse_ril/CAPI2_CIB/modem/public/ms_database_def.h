...
typedef enum
{
	...
	MS_LOCAL_PBK_ELEM_UNICODE_OPTIMIZE_CTR, 		///<Element type {::Boolean}, TRUE if Client wants BRCM to supports Unicode Optimization for Alpha ID on SIM as ETSI TS 102 221
    ...
    MS_NV_LOCAL_CC_TTY_ELEMENT,						///< CC TTY element	
