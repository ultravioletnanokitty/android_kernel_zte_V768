...
//******************************************************************************
//
// Function Name: PBK_ConvertEmailAlpha
// 
// Description: Convert phonebook Email alpha from internal format to API format.
//				- Email size doubles the size of the ADN alpha
//
//******************************************************************************
void PBK_ConvertEmailAlpha(PBK_API_Name_t *alpha_data, const UInt8 *name, UInt8 nameLen);
