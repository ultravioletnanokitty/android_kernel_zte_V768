...
static bool_t xdr_copy_enum(enum_t* dest, enum_t src)
{
	*dest = src;
	return TRUE;
}
...
bool_t xdr_CAPI2_SmsApi_AddCellBroadcastChnlReq_Req_t(void* xdrs, CAPI2_SmsApi_AddCellBroadcastChnlReq_Req_t *rsp)
{
	...
	if(
		xdr_UInt8(xdrs, &rsp->cbmiLen) &&
		xdr_copy_len(&len, (u_int)(rsp->cbmiLen)) && xdr_bytes(xdrs, (char **)(void*)&rsp->newCBMI, &len, 0xFFFF) &&
	1)
		return TRUE;
	else
		return FALSE;
...
static const struct xdr_discrim CAPI2_CcApi_ElementPtr_union_dscrm[] = {
	...
	{ (int)CC_ELEM_TEXT_TELEPHONY_MODE_SWITCH,_T("CC_ELEM_TEXT_TELEPHONY_MODE_SWITCH"),		(xdrproc_t)xdr_UInt8,sizeof( UInt8 ), NULL_capi2_proc_t, (xdrproc_t)xdr_UInt8,0 },
...
bool_t xdr_CAPI2_CcApi_SetElement_Req_t(void* xdrs, CAPI2_CcApi_SetElement_Req_t *rsp)
{
	...
	XDR_LOG(xdrs,"CAPI2_CcApi_SetElement_Req_t")
 	...
 	if(
		...
		(rsp->inCompareObjPtr== NULL ||
		(xdr_copy_enum(&en,(enum_t)(rsp->inElement)) && xdr_union(xdrs, (enum_t *)&en, (caddr_t)(void *)(rsp->inCompareObjPtr),CAPI2_CcApi_SetElement_inCompareObjPtr_union_dscrm,NULL_xdrproc_t, &entry, NULL) ) ) &&
 		xdr_pointer(xdrs, (char**)(void*)&rsp->outElementPtr,CAPI2_CcApi_SetElement_outElementPtr_union_length(rsp->inElement), xdr_void) &&
		(rsp->outElementPtr== NULL ||
		(xdr_copy_enum(&en,(enum_t)(rsp->inElement)) && xdr_union(xdrs, (enum_t *)&en, (caddr_t)(void *)(rsp->outElementPtr),CAPI2_CcApi_SetElement_outElementPtr_union_dscrm,NULL_xdrproc_t, &entry, NULL) ) ) &&
 	1)
        return TRUE;
	else
		return FALSE;
...
bool_t xdr_CAPI2_CcApi_GetElement_Req_t(void* xdrs, CAPI2_CcApi_GetElement_Req_t *rsp)
{
	...
	if(
		...
		xdr_pointer(xdrs, (char**)(void*)&rsp->inCompareObjPtr,CAPI2_CcApi_GetElement_inCompareObjPtr_union_length(rsp->inElement), xdr_void) &&
        	(rsp->inCompareObjPtr== NULL ||
		(xdr_copy_enum(&en,(enum_t)(rsp->inElement)) && xdr_union(xdrs, (enum_t *)&en, (caddr_t)(void *)(rsp->inCompareObjPtr),CAPI2_CcApi_GetElement_inCompareObjPtr_union_dscrm,NULL_xdrproc_t, &entry, NULL) ) ) &&
1)
		return TRUE;
	else
		return FALSE;
...
bool_t xdr_CAPI2_CcApi_GetElement_Rsp_t(void* xdrs, CAPI2_CcApi_GetElement_Rsp_t *rsp)
{
	...
	if(
		xdr_CcApi_Element_t(xdrs, &rsp->inElement) &&
        	xdr_copy_enum(&en,(enum_t)(rsp->inElement)) && xdr_union(xdrs, (enum_t *)&en,(caddr_t)(void *)(rsp->outElementPtr),CAPI2_CcApi_GetElement_outElementPtr_union_dscrm,NULL_xdrproc_t, &entry, NULL) &&
1)
		return TRUE;
	else
		return FALSE;
