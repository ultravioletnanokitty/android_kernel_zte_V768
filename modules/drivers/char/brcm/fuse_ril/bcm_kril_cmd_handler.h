...
/**
Context data for RIL_REQUEST_AGPS_OPEN_PKCS15
**/
typedef struct
{
	USIM_AID_DATA_t mAidData;
	UInt8 mSockID;
} AgpsOpenPkcs15Cxt;

/**
Context data for RIL_REQUEST_AGPS_SIM_EF_INFO
**/
typedef struct
{
	unsigned short mEfInfoPath;
	AgpsSimType mSimType;
} AgpsEfInfoCxt;
