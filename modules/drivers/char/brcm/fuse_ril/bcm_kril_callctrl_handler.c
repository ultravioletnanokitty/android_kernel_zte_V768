...
/// The DTMF tone duration should be 100 msec.
#define DTMF_TONE_DURATION  100
...
//liutao@wind-mobi.com 2012-2-13 begin
//fix 501922 current decrease from 700ma to 500ma in calling
//liubin@wind-mobi.com review
extern void pmu_enable_charging_current_change(int enable);
//liutao@wind-mobi.com 2012-2-13 end
//******************************************************************************
//
...
void KRIL_GetCurrentCallHandler(void *ril_cmd, Kril_CAPI2Info_t *capi2_rsp)
{
    ...
    switch(pdata->handler_state)
    {
		...
		//fix 501922 current decrease from 700ma to 500ma in calling
		//liubin@wind-mobi.com review
		pmu_enable_charging_current_change(0);
		//liutao@wind-mobi.com 2012-2-13 end
		...
		//fix 501922 current decrease from 700ma to 500ma in calling
		//liubin@wind-mobi.com review
			pmu_enable_charging_current_change(1);
		//liutao@wind-mobi.com 2012-2-13 end
