...
extern Boolean gIsSimCachedDataReady[DUAL_SIM_SIZE];
...
//
//******************************************************************************
UInt16 ParseCommandDetails(UInt8 *simple_tlv_ptr, void *pSATKdata, UInt8 cmdType, UInt8 cmdNum)
{
    UInt8 command_detail_data[5] = {0x81, 0x03, 0x01, 0x00, 0x00};
    UInt16 command_detail_length = 0;
    
    KRIL_DEBUG(DBG_INFO,"cmdType:0x%02X cmdNum:%d\n",cmdType, cmdNum);
    
    // Fill Commmand number only for Display text case
    if (STK_DISPLAYTEXT == cmdType)
    {
        command_detail_data[2] = cmdNum;
    }
...
//
//******************************************************************************
UInt16 ParseSATKSetupMenu(char* tlv_data_string, SATK_EventData_t *pSATKEventData)
{
    SetupMenu_t *pSetupMenu = pSATKEventData->u.setup_menu;
    UInt8 cmdNum = pSATKEventData->cmdNum;
    ...
    command_detail_length = ParseCommandDetails(simple_tlv_ptr, (void*)pSetupMenu, STK_SETUPMENU, cmdNum);
...
//
//******************************************************************************
UInt16 ParseSATKSelectItem(char* tlv_data_string, SATK_EventData_t *pSATKEventData)
{
    ...
    // Fill Command detail data
    command_detail_length = ParseCommandDetails(simple_tlv_ptr, (void*)pSelectItem, STK_SELECTITEM, cmdNum);
    if (!command_detail_length)
    {
        KRIL_DEBUG(DBG_ERROR,"ParseCommandDetails() return 0 Error!!\n");
        return 0;
...
//
//******************************************************************************
UInt16 ParseSATKGetInput(char* tlv_data_string, SATK_EventData_t *pSATKEventData)
{
    ...
    // Fill Command detail data
    command_detail_length = ParseCommandDetails(simple_tlv_ptr, (void*)pGetInput, STK_GETINPUT, cmdNum);
    if (!command_detail_length)
    {
        KRIL_DEBUG(DBG_ERROR,"ParseCommandDetails() return 0 Error!!\n");
        return 0;
...
//
//******************************************************************************
int ParseSATKGetInkey(char* tlv_data_string, SATK_EventData_t *pSATKEventData)
{
    ...
    // Fill Command detail data
    command_detail_length = ParseCommandDetails(simple_tlv_ptr, (void*)pGetInkey, STK_GETINKEY, cmdNum);
    if (!command_detail_length)
    {
        KRIL_DEBUG(DBG_ERROR,"ParseCommandDetails() return 0 Error!!\n");
        return 0;
...
//
//******************************************************************************
int ParseSATKDisplayText(char* tlv_data_string, SATK_EventData_t *pSATKEventData)
{
    ...
    // Fill Command detail data
    command_detail_length = ParseCommandDetails(simple_tlv_ptr, (void*)pDisplayText, STK_DISPLAYTEXT, cmdNum);
    if (!command_detail_length)
    {
        KRIL_DEBUG(DBG_ERROR,"ParseCommandDetails() return 0 Error!!\n");
        return 0;
...
//
//******************************************************************************
int ParseSATKSendMOSMS(char* tlv_data_string, SATK_EventData_t *pSATKEventData)
{
    ...
    // Fill Command detail data
    command_detail_length = ParseCommandDetails(simple_tlv_ptr, (void*)pSendMOSMS, STK_SENDSMS, cmdNum);
    if (!command_detail_length)
    {
        KRIL_DEBUG(DBG_ERROR,"ParseCommandDetails() return 0 Error!!\n");
        return 0;
...
//
//******************************************************************************
int ParseSATKSendSs(char* tlv_data_string, SATK_EventData_t *pSATKEventData)
{
    ...
    // Fill Command detail data
    command_detail_length = ParseCommandDetails(simple_tlv_ptr, (void*)pSendSs, STK_SENDSS, cmdNum);
    if (!command_detail_length)
    {
        KRIL_DEBUG(DBG_ERROR,"ParseCommandDetails() return 0 Error!!\n");
        return 0;
...
//
//******************************************************************************
int ParseSATKSendUssd(char* tlv_data_string, SATK_EventData_t *pSATKEventData)
{
    ...
    // Fill Command detail data
    command_detail_length = ParseCommandDetails(simple_tlv_ptr, (void*)pSendUssd, STK_SENDUSSD, cmdNum);
    if (!command_detail_length)
    {
        KRIL_DEBUG(DBG_ERROR,"ParseCommandDetails() return 0 Error!!\n");
        return 0;
...
//
//******************************************************************************
int ParseSATKPlayTone(char* tlv_data_string, SATK_EventData_t *pSATKEventData)
{
    ...
    // Fill Command detail data
    command_detail_length = ParseCommandDetails(simple_tlv_ptr, (void*)pPlayTone, STK_PLAYTONE, cmdNum);
    if (!command_detail_length)
    {
        KRIL_DEBUG(DBG_ERROR,"ParseCommandDetails() return 0 Error!!\n");
        return 0;
...
//
//******************************************************************************
int ParseSATKSendStkDtmf(char* tlv_data_string, SATK_EventData_t *pSATKEventData)
{
    ...
    // Fill Command detail data
    command_detail_length = ParseCommandDetails(simple_tlv_ptr, (void*)pSendStkDtmf, STK_SENDDTMF, cmdNum);
    if (!command_detail_length)
    {
        KRIL_DEBUG(DBG_ERROR,"ParseCommandDetails() return 0 Error!!\n");
        return 0;
...
//
//******************************************************************************
int ParseSATKSetupCall(char* tlv_data_string, SATK_EventData_t *pSATKEventData)
{
    ...
    // Fill Command detail data
    command_detail_length = ParseCommandDetails(simple_tlv_ptr, (void*)pSetupCall, STK_SETUPCALL, cmdNum);
    if (!command_detail_length)
    {
        KRIL_DEBUG(DBG_ERROR,"ParseCommandDetails() return 0 Error!!\n");
        return 0;
...
//
//******************************************************************************
int ParseSATKIdleModeText(char* tlv_data_string, SATK_EventData_t *pSATKEventData)
{
    ...
    // Fill Command detail data
    command_detail_length = ParseCommandDetails(simple_tlv_ptr, (void*)pIdleModeText, STK_SETUPIDLEMODETEXT, cmdNum);
    if (!command_detail_length)
    {
        KRIL_DEBUG(DBG_ERROR,"ParseCommandDetails() return 0 Error!!\n");
        return 0;
...
//
//******************************************************************************
int ParseSATKRefresh(char* tlv_data_string, SATK_EventData_t *pSATKEventData)
{
    ...
    // Fill Command detail data
    command_detail_length = ParseCommandDetails(simple_tlv_ptr, (void*)pRefresh, STK_REFRESH, cmdNum);
    if (!command_detail_length)
    {
        KRIL_DEBUG(DBG_ERROR,"ParseCommandDetails() return 0 Error!!\n");
        return 0;
...
//
//******************************************************************************
int ParseSATKLaunchBrowser(char* tlv_data_string, SATK_EventData_t *pSATKEventData)
{
    ...
    // Fill Command detail data
    command_detail_length = ParseCommandDetails(simple_tlv_ptr, (void*)pLaunchBrowserReq, STK_LAUNCHBROWSER, cmdNum);
    if (!command_detail_length)
    {
        KRIL_DEBUG(DBG_ERROR,"ParseCommandDetails() return 0 Error!!\n");
        return 0;
...
int ParseSATKSetupEventList(char* tlv_data_string, UInt16* pEventType)
{
    ...
    // Fill Command detail data
    command_detail_length = ParseCommandDetails(simple_tlv_ptr, pEventType, STK_EVENTLIST, cmdNum);
    if (!command_detail_length)
    {
        KRIL_DEBUG(DBG_ERROR,"ParseCommandDetails() return 0 Error!!\n");
        return 0;
...
int ParseSATKLanguageNotification(char* tlv_data_string, StkLangNotification_t* plang)
{
    ...
    // Fill Command detail data
    command_detail_length = ParseCommandDetails(simple_tlv_ptr, plang, STK_LANGUAGENOTIFICATION, cmdNum);
    if (!command_detail_length)
    {
        KRIL_DEBUG(DBG_ERROR,"ParseCommandDetails() return 0 Error!!\n");
        return 0;
...
void ProcessSATKSetupMenu(Kril_CAPI2Info_t *dataBuf)
{
    ...
    if (!pSATKEventData)
    {
        KRIL_DEBUG(DBG_ERROR,"pSATKEventData is NULL. Error!!\n");
        return;
    }
    
    tlv_length = ParseSATKSetupMenu(tlv_data_string, pSATKEventData);
    if (!tlv_length)
    {
...
void ProcessSATKSelectItem(Kril_CAPI2Info_t *dataBuf)
{
    ...
    tlv_length = ParseSATKSelectItem(tlv_data_string, pSATKEventData);
    if (!tlv_length)
    {
...
void ProcessSATKGetInput(Kril_CAPI2Info_t *dataBuf)
{
    ...
    tlv_length = ParseSATKGetInput(tlv_data_string, pSATKEventData);
    if (!tlv_length)
    {
...
void ProcessSATKGetInkey(Kril_CAPI2Info_t *dataBuf)
{
    ...
    tlv_length = ParseSATKGetInkey(tlv_data_string, pSATKEventData);
    if (!tlv_length)
    {
...
void ProcessSATKDisplayText(Kril_CAPI2Info_t *dataBuf)
{
    ...
    tlv_length = ParseSATKDisplayText(tlv_data_string, pSATKEventData);
    if (!tlv_length)
    {
...
void ProcessSATKSendMOSMS(Kril_CAPI2Info_t *dataBuf)
{
    ...
    tlv_length = ParseSATKSendMOSMS(tlv_data_string, pSATKEventData);
    if (!tlv_length)
    {
...
void ProcessSATKSendSs(Kril_CAPI2Info_t *dataBuf)
{
    ...
    tlv_length = ParseSATKSendSs(tlv_data_string, pSATKEventData);
    if (!tlv_length)
    {
...
void ProcessSATKSendUssd(Kril_CAPI2Info_t *dataBuf)
{
    ...
    tlv_length = ParseSATKSendUssd(tlv_data_string, pSATKEventData);
    if (!tlv_length)
    {
...
void ProcessSATKPlayTone(Kril_CAPI2Info_t *dataBuf)
{
    ...
    tlv_length = ParseSATKPlayTone(tlv_data_string, pSATKEventData);
    if (!tlv_length)
    {
...
void ProcessSATKSendStkDtmf(Kril_CAPI2Info_t *dataBuf)
{
    ...
    tlv_length = ParseSATKSendStkDtmf(tlv_data_string, pSATKEventData);
    if (!tlv_length)
    {
...
void ProcessSATKSetupCall(Kril_CAPI2Info_t *dataBuf)
{
    ...
    tlv_length = ParseSATKSetupCall(tlv_data_string, pSATKEventData);
    if (!tlv_length)
    {
...
void ProcessSATKIdleModeText(Kril_CAPI2Info_t *dataBuf)
{
    ...
    tlv_length = ParseSATKIdleModeText(tlv_data_string, pSATKEventData);
    if (!tlv_length)
    {
...
void ProcessSATKRefresh(Kril_CAPI2Info_t *dataBuf)
{
    ...
    pRefresh = pSATKEventData->u.refresh;
    ...
    tlv_length = ParseSATKRefresh(tlv_data_string, pSATKEventData);
...
void ProcessSATKLaunchBrowser(Kril_CAPI2Info_t *dataBuf)
{
    ...
    tlv_length = ParseSATKLaunchBrowser(tlv_data_string, pSATKEventData);
    if (!tlv_length)
    {
        KRIL_DEBUG(DBG_ERROR,"ParseSATKIdleModeText() return 0 Error!!\n");
        return;    
...
void  ProcessNewSMSMessage(Kril_CAPI2Info_t * data)
{
    ...
    {
    //lvjinlong@wind-mobi.com start 2012.06.21
    //csp 538696 patch
        if (FALSE == KRIL_GetMESMSAvailable())
        {
            KrilMsgAckInfo_t *tdata = kmalloc(sizeof(KrilMsgAckInfo_t), GFP_KERNEL);
            if(!tdata) {
                KRIL_DEBUG(DBG_ERROR, "unable to allocate tdata buf\n");
                return;
            }
            tdata->AckType = 0;
            tdata->FailCause = 0xD3;//SMS_ACK_MEM_EXCEEDED;
            if(!KRIL_DevSpecific_Cmd(BCM_KRIL_CLIENT, data->SimId, BRCM_RIL_REQUEST_SMS_ACKNOWLEDGE, tdata, sizeof(KrilMsgAckInfo_t)))
            {
                KRIL_DEBUG(DBG_ERROR,"Command RIL_REQUEST_SMS_ACKNOWLEDGE failed\n");
            }
            kfree(tdata);
        }
        else
        {
    //lvjinlong@wind-mobi.com end 2012.06.21
        ...
        if (data->SimId < SIM_SINGLE || data->SimId > SIM_DUAL_SECOND) {
            KRIL_DEBUG(DBG_ERROR, "%s() Invalid SimId %d\n", __FUNCTION__, data->SimId);
            kfree(tdata);
            return;
        }
...
void ProcessUssdNotification(Kril_CAPI2Info_t* notify)
{
    ...
    else if (notify->msgType == MSG_MNSS_CLIENT_SS_SRV_REL)
    {
        ...
        switch(srvRel_rsp->type)
        {
           ...
           {
                rdata->type = 0; // "0"   USSD-Notify -- text in ((const char **)data)[1]
                //limeijuan@wind-mobi.com 20120209 begin
                //add the brcm patch
                ...
                //limeijuan@wind-mobi.com 20120209 end
                ProcessUssdData(srvRel_rsp->operation, &srvRel_rsp->param.ussdInfo, rdata);
                KRIL_SendNotify(notify->SimId, BRCM_RIL_UNSOL_ON_USSD, rdata, sizeof(KrilReceiveUSSDInfo_t));
           }
           break;
...
//lvjinlong@wind-mobi.com start 2012.04.07
//brcm'patch for cmas,csp id:516366
Unicode_t IdentifyCodingScheme(char pdu)
{
    int dataCodingScheme = pdu & 0xff;
    Unicode_t encodingType;
    ...
    if ((dataCodingScheme & 0x80) == 0) {
        ...
        if (userDataCompressed) {
            KRIL_DEBUG(DBG_ERROR, "2 - Unsupported SMS data coding scheme:%d\n",(dataCodingScheme & 0xff));
        } else {
            switch ((dataCodingScheme >> 2) & 0x3) {
            case 0: // GSM 7 bit default alphabet
                encodingType = UNICODE_GSM;
                break;
            case 2: // UCS 2 (16bit)
                encodingType = UNICODE_UCS2;
                break;
            case 1: // 8 bit data
            case 3: // reserved
                KRIL_DEBUG(DBG_ERROR, "1 - Unsupported SMS data coding scheme:%d\n",(dataCodingScheme & 0xff));
                encodingType = UNICODE_UCS1;
                break;
            }
        }
        ...
        KRIL_DEBUG(DBG_ERROR, "3 - Unsupported SMS data coding scheme:%d\n",(dataCodingScheme & 0xff));
    }

    return encodingType;
}

void fill7Bit_CR(char *src, int NoPages)
{
    char CR_Pattern[7]={0x8D, 0x46,0xA3,0xD1,0x68,0x34,0x1A};    
    int i,j,remainder;
    char *dest;

    remainder = (((NoPages-1) * 82) %7);
    dest = src+6;
    for(i=0; i<82; i++) {
        j = remainder + i;
        *dest++ = CR_Pattern[j%7];
...
void fillPatter_CR(char *pdu, int NoPages)
{
    Unicode_t encodingType;

    encodingType = IdentifyCodingScheme(pdu[4]);

    switch(encodingType) {
    case UNICODE_GSM:
        KRIL_DEBUG(DBG_INFO,"7 Bit\n");
        fill7Bit_CR(pdu, NoPages);
        break;
    case UNICODE_UCS1:
        KRIL_DEBUG(DBG_INFO,"8 Bit\n");
        memset(&pdu[6], 0xd, 82);
        break;
    case UNICODE_UCS2:
        KRIL_DEBUG(DBG_INFO,"16 Bit\n");
        fillUCS2_CR(pdu);
        break;
    }
}

void modifylastchar(char *src, int NoPages, int Num_Of_Octets)
{
    int remainder = (82*(NoPages-1) + Num_Of_Octets) % 7;
    src += (Num_Of_Octets-1);

    KRIL_DEBUG(DBG_INFO,"Num_Of_Octets:%d src:%x\n", Num_Of_Octets, *src);
    switch(remainder){
    case 1:
        *src = *src & 0x7F;
        *src = *src | 0x80;
...
//lvjinlong@wind-mobi.com end 2012.04.07
...
void ProcessNotification(Kril_CAPI2Info_t *notify)
{
    ...
    switch((UInt32)notify->msgType)
    {
        ...
        case MSG_RADIO_ACTIVITY_IND:
        {
            ...
            //lvjinlong@wind-mobi.com start 2012.06.20
            // csp 504785 ,Urgent [CB] Random memory corrupt
            //memcpy(&gRadioAcTInfo[notify->SimId], pRadio, sizeof(MSRegInfo_t));
            memcpy(&gRadioAcTInfo[notify->SimId], pRadio, sizeof(MSRadioActivityInd_t));
            //lvjinlong@wind-mobi.com end 2012.06.20
            break;
        }
        ...
        case MSG_SIM_CACHED_DATA_READY_IND:
            KRIL_DEBUG(DBG_INFO, "MSG_SIM_CACHED_DATA_READY_IND[%d]\n", notify->SimId);
            gIsSimCachedDataReady[notify->SimId] = TRUE;
        ...
        case MSG_SMSCB_DATA_IND:
        {
            ...
            if (CB_DATA_PER_PAGE_SZ > pind->NoOctets)
            {
                fillPatter_CR(data, pind->NbPages);
                memcpy(&data[6], pind->Msg, pind->NoOctets);
                modifylastchar(&data[6], pind->NbPages, pind->NoOctets);                
            }
            else
            if (pind->NoOctets == CB_DATA_PER_PAGE_SZ)
            {
                memcpy(&data[6], pind->Msg, pind->NoOctets);
            }
			//lvjinlong@wind-mobi.com end 2012.04.07
           ...
           // memcpy(&data[6], pind->Msg, pind->NoOctets);
            ...
            KRIL_DEBUG(DBG_ERROR,"Ser 0x%x, Msg 0x%x, Dcs %d, NoP %d, NbP %d, NoOctets %d\n", pind->Serial, pind->MsgId, pind->Dcs, pind->NoPage, pind->NbPages, pind->NoOctets);
