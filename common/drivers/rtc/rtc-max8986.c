...
/* yaogangxiang@wind-mobi.2012.01.30 begin */
...
/* yaogangxiang@wind-mobi.2012.01.30 end */
...
static int max89xx_rtc_resume(struct device *dev)
{
	 ...
	 */
	max89xx_rtc_alarm_irq_enable(dev, 0);
/* yaogangxiang@wind-mobi.com 2012.01.30 begin */
    max89xx_rtc_alarm_enable(dev,0);
/* yaogangxiang@wind-mobi.com 2012.01.30 end */
#endif
