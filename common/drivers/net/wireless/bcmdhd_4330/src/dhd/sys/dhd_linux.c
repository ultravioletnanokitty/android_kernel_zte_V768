...
//	int power_mode = PM_MAX;
	...
	if (dhd && dhd->up) {
		if (value && dhd->in_suspend) {
				...
				//xiaoyafei@wind-mobi.com 2012.06.07 begin
				//merge csp537647
				...
				//xiaoyafei@wind-mobi.com 2012.06.07 end
...
static void dhd_suspend_resume_helper(struct dhd_info *dhd, int val)
{
	...
	//liutao@wind-mobi.com 2012-1-14 begin
       //fix 493932 wifi sleep current is about 10-20ma
       //liubin@wind-mobi.com 2012-1-14 review
       dhdp->in_suspend = val;
	//liutao@wind-mobi.com 2012-1-14 end
...
#if defined(CONFIG_WIRELESS_EXT)
#if SOFTAP
	if (event->bsscfgidx == 0 || (ap_fw_loaded == TRUE)) {
#else
