...
//liubing@wind-mobi.com 2012-01-06 begin
//for fix csp 490540,usr image cann't wakeup
#define uart_has_tty(po)     	((po)->state->port.tty)
#define uart_has_no_tty(po)	(!uart_has_tty(po))
//liubing@wind-mobi.com 2012-01-06 end
...
//liubing@wind-mobi.com 20110115 begin
//orig file form patch 1.3.2 have not if defined
#if defined(MOD_8250_FOR_BRCM)
		if (!serial_ucr_pdstate(up)) serial_ucr_pden(up, 0);
#endif
//liubing@wind-mobi.com 20110115 end        
