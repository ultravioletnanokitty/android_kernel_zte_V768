...
*	BMA222 linux driver
* 
* Usage:	BMA222 driver by i2c for linux
*
* 
...
#if BMA222_DEBUG
	printk("bma222_proc_read: success full\n");
#endif
	*eof = (len <= count) ? 1 : 0;
	*start = page + off;
	return len;
...
static DEVICE_ATTR(calibrate, S_IRUGO | S_IWUSR | S_IWOTH, bma222_fs_cal, NULL);
...
{
#if BMA222_DEBUG
	printk(KERN_INFO "BMA222_ACCEL exit\n");
#endif
