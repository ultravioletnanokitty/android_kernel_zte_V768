...
#ifndef __LCD_HX8369A_TM040YDZ01_COMPATIBLE_H__
#define __LCD_HX8369A_TM040YDZ01_COMPATIBLE_H__
...
#endif
#define LCD_INFO_ALIAS(var)	hx8369a_tm040ydz01##_##var
...
const char LCD_INFO_ALIAS(LCD_panel_name)[] = "HX8369A_TM040YDZ01 LCD";
...
static uint8_t LCD_INFO_ALIAS(param2)[] = {
	     0x01,0x00,0x34,0x0A,0x00,0x11,0x11,0x32,
		 0x2F,0x3F,0x3F,0x01,0x3A,0x01,0xE6,0xE6,
		 0xE6,0xE6,0xE6,
};
...
static uint8_t param4[] =  {0x02, 0x18,
    	 ...
    	 0x72};
*/
static uint8_t LCD_INFO_ALIAS(param4)[] = {0x02, 0x1D, 0x80, 0x06,0x02};
static uint8_t LCD_INFO_ALIAS(param5)[] = {0x4B, 0x4B}; 
static uint8_t LCD_INFO_ALIAS(param9)[] = { 
		0x00, 0x01,0x03, 0x34,0x34, 0x04,0x00, 0x70,
		0x11, 0x13,0x00, 0x00,0x60, 0x24,0x71, 0x35,
		0x00, 0x00,0x71, 0x05,0x60, 0x04,0x07, 0x0F,
		0x04, 0x04};

static uint8_t LCD_INFO_ALIAS(param6)[] =  {	 
		0x00,0x02,0x0B,0x13,0x0B,0x18,0x24,0x30,
		0x09,0x13,0x0F,0x15,0x15,0x14,0x15,0x0C,
		0x0C,0x00,0x02,0x0B,0x13,0x0B,0x18,0x24,
		0x30,0x09,0x13,0x0F,0x15,0x15,0x14,0x15,
		0x0C,0x0C
};

static uint8_t LCD_INFO_ALIAS(param7)[] =  {
		0x00,0xA0,0xC6,0x00,0x0A,0x00,0x10,0x30, 
		0x6F,0x02,0x10,0x18,0x40};
...
static lcd_dsi_drv_info_t lcd_hx8369a_tm040ydz01 = {	
