...
*
*  PURPOSE:
*    This is the LCD-specific code for a R61581B0 module.    //xinli lcd
*
*****************************************************************************/

#ifndef __BCM_LCD_R61581B0__
#define __BCM_LCD_R61581B0__

#define MIPI_DCS_NOP					    0x00
#define MIPI_DCS_SOFT_RESET				    0x01
#define MIPI_DCS_READ_DDB_START		        0x04  //ADD
...
const char *LCD_panel_name = "RENESAS HVGA R61581B0 Controller";
...
CSL_LCDC_PAR_SPEED_t timingReg = {31, 24, 1, 1, 2, 0};//
CSL_LCDC_PAR_SPEED_t timingMem = {31, 24, 1, 1, 2, 0};//
...
Lcd_init_t power_on_seq[] = {
	...
	{WR_DATA, 0x00, 0x00},
	{WR_DATA, 0x00, 0x01},
	{WR_DATA, 0x00, 0x3F},//320
	
	{WR_CMND, MIPI_DCS_SET_PAGE_ADDRESS, 0},
	{WR_DATA, 0x01, 0x00},
	{WR_DATA, 0x00, 0x00},
	{WR_DATA, 0x00, 0x01},
	{WR_DATA, 0x00, 0xDF},//480
	
	{WR_CMND_DATA, MIPI_DCS_SET_TEAR_ON, 0x00},

	{WR_CMND_DATA, MIPI_DCS_SET_ADDRESS_MODE, 0x80},//add   ?   page address from bottom to top
	
//#ifdef CONFIG_ARGB8888
	{WR_CMND_DATA, MIPI_DCS_SET_PIXEL_FORMAT, 0x55},//16 bpp
//#else
//	{WR_CMND_DATA, MIPI_DCS_SET_PIXEL_FORMAT, 0x66},//18 bpp
//#endif
	...
	{WR_CMND, DISPLAY_MODE_FRAME_MEMORY_WRITE_MODE_SETTING, 0x00},
	{WR_DATA, 0x00, 0x00},
	{WR_DATA, 0x00, 0x2C},
	{SLEEP_MS, 0, 20},
