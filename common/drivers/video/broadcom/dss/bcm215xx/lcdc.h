...
#elif defined(CONFIG_BCM_LCD_R61581B0)    //add by xiongbiao
#include "../../displays/lcd_R61581B0.h"
...
#elif defined(CONFIG_BCM_LCD_ILI9486L)   //add by xiongbiao
#include "../../displays/lcd_ILI9486L.h"
//xiongbiao@wind-mobi.com 2011.10.31 begin
//Add HX8357B LCD support.
#elif defined(CONFIG_BCM_LCD_HX8357B)   //add by xiongbiao
#include "../../displays/lcd_HX8357B.h"
//xiongbiao@wind-mobi.com 2011.10.31 end
//xiongbiao@wind-mobi.com 2011.10.31 begin
//Add HX8357B LCD support.
#elif defined(CONFIG_BCM_LCD_HX8357C)   //add by xiongbiao
...
//support lcd compatible
//reviewed by liubing@wind-mobi.com
#elif defined(CONFIG_LCD_DRV_ALL)
#include "../../displays/lcd_ILI9486L_compatible.h"
#include "../../displays/lcd_HX8357B_compatible.h"
#include "../../displays/lcd_HX8357C_compatible.h"
//shaojiang@wind-mobi.com 2011.11.14 end
#endif
