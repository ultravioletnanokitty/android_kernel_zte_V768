...
//modify by yangjiajun@wind-mobi.com 2012-8-9 begin
//requirement for product-line, uart port must not output log.
#define DEFAULT_CONSOLE_LOGLEVEL 0 /* anything MORE serious than KERN_DEBUG */
//modify by yangjiajun@wind-mobi.com 2012-8-9 end
