...
#define HW_BSC2_BASE_CAM                     IO_ADDRESS(BCM21553_I2S_BASE)  
//hanwei@wind-mobi.com add-s 2011.11.18 end
...
//hanwei@wind-mobi.com add-s 2011.11.18 start
//for config camera flash port:GPIO30 address
//reviewed by liubing@wind-mobi.com
#define   ADDR_SYSCFG_GPORCMA                           (HW_BSC2_BASE_CAM + 0xE010)   
#define   ADDR_SYSCFG_GPORCMA_OFFSET	    (0x3)
#define   ADDR_SYSCFG_IOCR5_OFFSET	    (1<<30)

//hanwei@wind-mobi.com add-s 2011.11.18 end
//heweimao@wind-mobi.com 2011.11.04 begin
//L300 LED  red gpio48
//reviewed by yuanlan@wind-mobi.com 
#define   SYSCFG_IOCR7_RFGPIO48_GPIO7_MUX	    (1 << 28)
