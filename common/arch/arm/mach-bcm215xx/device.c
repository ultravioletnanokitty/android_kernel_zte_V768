...
//Modify the SS turbo mode voltaqe from 1.36V to 1.38V for China 832Mhz program.
//hebin@wind-mobi.com begin 2012.5.24
#if defined(CONFIG_BOARD_L400) || defined(CONFIG_BOARD_PASCAL) || defined(CONFIG_BOARD_ACAR)
#define NM2_SS_VOLTAGE_TURBO	1380000
#else
#define NM2_SS_VOLTAGE_TURBO	1360000
#endif
//hebin@wind-mobi.com end 2012.5.24
