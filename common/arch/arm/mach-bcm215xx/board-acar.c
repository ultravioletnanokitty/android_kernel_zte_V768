...
/* xiongbiao@wind-mobi.com 2012.02.14 begin*/
/* Add Sitronix Capacitive touch panel support */
#ifdef CONFIG_TOUCHSCREEN_SITRONIX_I2C_TOUCH
#include <linux/sitronix_i2c_touch.h>
#define BOARD_VIRTUALKEY_SITRONIX
#endif
/* xiongbiao@wind-mobi.com 2012.02.14  end*/
...
//add light/proximity support	
#if defined(CONFIG_SENSORS_LTR558)
...
//heweimao@wind-mobi.com 2011.12.14 begin
//L300 red led gpio
//reviewed by liubing@wind-mobi.com 
//yaogangxiang@wind-mobi.com 2011.12.23 begin 
#define GPIO_RED_LED 			(39)

//#define GPIO_RED_LED 			(48)
//#define GPIO_RED_LED 			(2)
//heweimao@wind-mobi.com 2011.12.14 end
//yaogangxiang@wind-mobi.com 2011.12.23 end 
...
static int tmd2771x_gpio_init(void)
{
    gpio_request(TMD2771X_GPIO, "tmd2771x"); // PS sensor interrupt
...
static void tmd2771x_gpio_free(struct device *dev)
{
    gpio_free(TMD2771X_GPIO);
}

struct tmd2771x_platform_data tmd2771x_pdata = {
	.init = tmd2771x_gpio_init,
    .exit = tmd2771x_gpio_free,
...
#ifdef CONFIG_BACKLIGHT_KTD259
static struct platform_ktd259_backlight_data bcm_backlight_data = {
	.max_brightness = 32,	/* Android calibrates to 32 levels*/
	.dft_brightness = 32,
...
#if (defined (CONFIG_TOUCHSCREEN_MSI_ATMEGA168)|| defined (CONFIG_TOUCHSCREEN_GT818)||defined (CONFIG_TOUCHSCREEN_FT5X06))
...
/* Add Sitronix Capacitive touch panel support */
#ifdef CONFIG_TOUCHSCREEN_SITRONIX_I2C_TOUCH
#define MULTITOUCH_RESET_GPIO 28
static void sitronix_reset_ic(void){
    printk("%s\n", __FUNCTION__);
    gpio_request(MULTITOUCH_RESET_GPIO, "Multitouch Reset"); 
    gpio_direction_output(MULTITOUCH_RESET_GPIO, 1); 
    mdelay(1);
...
{
    //printk("%s\n", __FUNCTION__);
    return gpio_get_value(29); 
}
static int sitronix_init_irq(void)
{
    gpio_request(29, "sitronix-ts");
...
static int sitronix_exit_ic(void)
{
	//gpio_direction_input(29);
	gpio_free(29);
...
/* close it,fix ft5206 can't wake up */
    printk("%s\n", __FUNCTION__);
	gpio_request(TP_RST, "ft5x06_Reset"); 
...
static struct i2c_board_info __initdata i2c_gpio_devices[] = {  
 ...
 /* xiongbiao@wind-mobi.com 2011.12.13 end*/
  ...
  /* xiongbiao@wind-mobi.com 2011.01.11 begin*/
  /* Add ILITEK 2102T Capacitive touch panel support */
#ifdef CONFIG_TOUCHSCREEN_ILITEK_2102T
	  {
...
#endif 
  /* xiongbiao@wind-mobi.com 2011.01.11 end*/

 /* xiongbiao@wind-mobi.com 2012.02.14 begin*/
 /* Add Sitronix Capacitive touch panel support */
#ifdef CONFIG_TOUCHSCREEN_SITRONIX_I2C_TOUCH
 	  {
	   I2C_BOARD_INFO("sitronix", 0x55),
	   .platform_data = (void *)&touch_i2c_conf,
	   .irq = GPIO_TO_IRQ(29),
	  },
#endif
 /* xiongbiao@wind-mobi.com 2012.02.14 end*/
...
//add light/proximity support	
#if defined(CONFIG_SENSORS_LTR558)
static int ltr_gpio_init(void)
{
        gpio_request(14, "ltr558"); // PS sensor interrupt
        gpio_direction_input(14);
        set_irq_type(GPIO_TO_IRQ(14), IRQF_TRIGGER_FALLING);
        return 0;
}

static void ltr_gpio_free(struct device *dev)
{
        gpio_free(14);
}

static struct ltr558_platform_data lps_pdata = {
        .init = ltr_gpio_init,
        .exit = ltr_gpio_free,
        .i2c_pdata = {.i2c_spd = I2C_SPD_100K,},
};
...
/* songjinguo@wind-mobi.com 2011.12.06 start */
/* change the max/min charging current */
/* review by liubing */
...
/* songjinguo@wind-mobi.com 2011.12.06 end */
...
/* review by liubing */
      static u16 bat_vol[] = {3300, 3600, 3695, 3725, 3760, 3790, 3820, 3850, 3880, 3920, 3955, 4015, 4160};
...
#ifdef BATTERY_ADC_FIX
//static u16 bat_vol_charging[] = {3390, 3690, 3780, 3830, 3865, 3905, 3935, 3960, 3985, 4010, 4040, 4060, 4100, 4150, 4220};
static u16 bat_vol_charging_usb[] = {3370, 3680, 3780, 3800, 3835, 3865, 3895, 3925, 3955, 3985, 4020, 4080, 4210};
static u16 bat_vol_charging_ac[] = {3400, 3720, 3820, 3850, 3885, 3915, 3945, 3975, 4005, 4035, 4065, 4120, 4220};
...
static struct brcm_headset_pd headset_pd = {
	...
	.debounce_ms    = 400,
//yuanlan@wind-mobi.com 2011.12.31 begin
//fix the bug #6786 for headset key can not answer the call
    .keypress_threshold_lp  = 0x5E00,
    .keypress_threshold_fp  = 0x6000,
//yuanlan@wind-mobi.com 2011.12.31 end
};
#endif
/* songjinguo@wind-mobi.com 2011.11.28 end	*/
...
/* set gpio 13 to output pull up, can reduce the standby current */ 
/* review by liubing */
...
{
#if defined(BOARD_VIRTUALKEY)|| defined(BOARD_VIRTUALKEY_FT5X06)
