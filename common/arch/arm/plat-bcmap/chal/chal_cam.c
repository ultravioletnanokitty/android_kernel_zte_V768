...
//songjinguo@wind-mobi.com 20120531 start
//fix cp crash, csp:515147			
		  BRCM_WRITE_REG(pCamDevice->baseAddr,CAMINTF_CSI2RSA0, 0x00);
		  BRCM_WRITE_REG(pCamDevice->baseAddr,CAMINTF_CSI2REA0, 0x00);		
//songjinguo 20120531 end
        // Software Reset
