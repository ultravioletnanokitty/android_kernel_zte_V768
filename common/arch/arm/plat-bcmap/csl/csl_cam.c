    ...
    *cslCamH = NULL;
    ...
    // If Initial Channel opening on Interface
        ...
        // Set default Controller settings                        
            chal_cam_cfg_cntrl_st.packet_timeout = 32; // chg for L400 camera driver debug
#else
        // Set default Controller settings           
            chal_cam_cfg_cntrl_st.packet_timeout = 20;//16; //for camera huaping after merge broadcom patch L301_2012-2-3_2
#endif
...
// Return Clock Handle
    ...
    {            
    //DBG_OUT_REGISTER_DISPLAY( csl_cam_register_display( (CSL_CAM_HANDLE)camH ) );
    csl_cam_register_display( (CSL_CAM_HANDLE)camH ) ;//add for L400 camera mipi debug
    }
    return success;
}
...
// Channel
	...
	printk(KERN_ERR"intf %d chan %d \n",chal_cam_param_st.intf, chal_cam_param_st.chan );
    chal_cam_param_st.param = 0x00000000;
