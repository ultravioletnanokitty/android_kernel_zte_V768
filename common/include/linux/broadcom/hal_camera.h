...
typedef enum {
	...
	CamDigEffect_Exposure = 0x00000019,	/* /< exposure */  		//add by hanwei
	CamDigEffect_Sepia = 0x00000011,	/* /< sepia */  				//add by hanwei
	...
	CamDigEffect_Red_Tint = 0x40000011,	/* /< red */ //add by hanwei
	CamDigEffect_Green_Tint = 0x40000033,	/* /< greenish */ //add by hanwei
	CamDigEffect_Blue_Tint = 0x40000022,	/* /< bluenish *///add by hanwei
...
typedef enum {
	...
	CamWB_Fluorescent = 0x00000080,	/* /<fluorescent *///hanwei add 2011.12.01
	CamWB_CoolFluorescent = 0x00000040,	/* /< cool fluorescent */
	//CamWB_DaylightFluorescent = 0x00000080, /* /< daylight fluorescent */ //hanwei del 2011.12.01
