...
//shengbotao@wind-mobi.com 20120207 begin
// 3D memery[1024*1024*60] modify to [1024*1024*45]
//pengzhiping@wind-mobi.com 2012.03.23  begin
// for L400 3D game update 80M BMEM 
// for L301 3D game update 80M BMEM  pengzhiping 2012.03.29
#if defined (CONFIG_BRCM_V3D_OPT)
	#if defined (CONFIG_BCM_LCD_NT35582)
		#define BMEM_SIZE  (1024*1024*80)
	#else
		#if defined(CONFIG_BOARD_L400)|| defined(CONFIG_BOARD_PASCAL)
		#define BMEM_SIZE  (1024*1024*80) // for L400 use 60M BMEM 2012.03.15 hanwei
		#else
		#define BMEM_SIZE  (1024*1024*45) //for L300/L301 use 45M BMEM 
		#endif
	#endif
#endif
//pengzhiping@wind-mobi.com 2012.03.23  begin
//shengbotao@wind-mobi.com 20120207 end
